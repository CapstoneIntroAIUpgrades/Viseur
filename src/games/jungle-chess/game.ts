...
import { GameState, JungleChessDelta } from "./state-interfaces";
...
export class Game extends BaseGame {
    ...
    public static readonly gameName = "JungleChess";
    ...
    protected renderBackground(
        ...
        delta: Immutable<JungleChessDelta>,
        nextDelta: Immutable<JungleChessDelta>,
    ): void {
