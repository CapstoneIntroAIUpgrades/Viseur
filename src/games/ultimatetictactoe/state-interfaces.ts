...
/** All the possible specific deltas in UltimateTicTacToe. */
export type UltimateTicTacToeSpecificDelta =
    | GameObjectLogRanDelta
    | AIMakeMoveFinishedDelta;

/** The possible delta objects in UltimateTicTacToe. */
export type UltimateTicTacToeDelta = GameSpecificDelta<UltimateTicTacToeSpecificDelta>;
