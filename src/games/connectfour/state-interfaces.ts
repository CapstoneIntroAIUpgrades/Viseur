...
export interface PlayerState extends GameObjectState, BasePlayer {
    ...
    /**
     * The color (side) of this player. Either 'red' or 'yellow', with the 'red'
...
/** All the possible specific deltas in ConnectFour. */
export type ConnectFourSpecificDelta =
    | GameObjectLogRanDelta
    | AIMakeMoveFinishedDelta;

/** The possible delta objects in ConnectFour. */
export type ConnectFourDelta = GameSpecificDelta<ConnectFourSpecificDelta>;
