// This is where you build your the Human player interactions with Viseur for the UltimateTicTacToe game.
...
/**
 * This is the class to play the UltimateTicTacToe game as a human.
...
export class HumanPlayer extends BaseHumanPlayer {
     ...
     * value: A move that the AI wants to make. Format varies based on sub-game
     */
